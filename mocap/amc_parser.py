...
if __name__ == '__main__':
  #test_all()
  asf_path = '../all_asfamc/subjects/20/20.asf'
  amc_path = '../all_asfamc/subjects/20/20_06.amc'
  joints = parse_asf(asf_path)
  motions = parse_amc(amc_path)
  length=len(motions)

  asf_path_2 = '../all_asfamc/subjects/21/21.asf'
  amc_path_2 = '../all_asfamc/subjects/21/21_06.amc'
