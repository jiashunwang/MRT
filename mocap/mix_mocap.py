...
# 2000 sequences have 2 subjects and 1 single subject, 4000 sequences have 3 single subject
...
data=[]
for i in range(6000):
    #2000 sequences have 2 subjects and 1 single subject
    if i<3000:
    ...
    #4000 sequences have 3 single subject
    else:
